...
loop do
  begin
    ...
    puts "Please enter the second number (or leave blank if the operation doesn't require a second number)"
    ...
    puts "Please choose an operation: add, subtract, multiply, divide, power, modulo, logarithm, square_root"
    operation = gets.chomp.downcase
    break if operation == "exit"

    valid_operations = ["add", "subtract", "multiply", "divide", "power", "modulo", "logarithm", "square_root"]
    raise ArgumentError, "Invalid operation" unless valid_operations.include?(operation)
